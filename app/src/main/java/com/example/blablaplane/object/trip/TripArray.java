...
public class TripArray extends ArrayList<Trip> {
    ...
    private TripArray() {
        super();
        add(new Trip(0, "2021-05-01 08:25:00", "2021-05-01 12:20:00", City.NICE, City.PARIS, 400.5F, "mariorossigmailcom", 3));
        add(new Trip(1, "2021-05-01 10:00:00", "2021-05-01 15:25:00", City.BORDEAUX, City.LILLE, 100F, "luigiverdigmailcom", 6));
        add(new Trip(2, "2021-05-01 12:00:00", "2021-05-01 21:40:00", City.BERLIN, City.PARIS, 250F, "giovannibianchigmailcom", 2));
        add(new Trip(3, "2021-05-01 22:05:00", "2021-05-01 23:00:00", City.MONTPELLIER, City.PARIS, 200F, "francescogmailcom", 1));
        add(new Trip(4, "2021-05-01 17:12:00", "2021-05-01 18:00:00", City.MARSEILLE, City.STRASBOURG, 110F, "mariorossigmailcom", 4));
        add(new Trip(5, "2021-05-01 02:45:00", "2021-05-01 08:06:00", City.AMSTERDAM, City.PISE, 150F, "luigiverdigmailcom\"", 2));
    }
